...
int main(int argc, char* argv[])
{
    ...
    ///APPID请勿随意改动
	const char* login_configs = "appid = 538849f9, work_dir =   .  ";//登录参数  test:538849f9, user:538293af
	const char* param1 = "sub=iat,auf=audio/L16;rate=16000,aue=speex-wb,ent=sms16k,rst=plain,rse=gb2312,vad_speech_tail=3000";//可参考可设置参数列表
	...
	// run_iat("wav/iflytek04.wav" ,  param1);                                     //iflytek09对应的音频内容“沉舟侧畔千帆过，病树前头万木春。”
